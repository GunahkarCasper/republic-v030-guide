...
🛠️ Troubleshooting: If your node gets stuck at block 326250
Sometimes Cosmovisor might fail to switch binaries automatically. If you see your block height stuck at 326250 and get UPGRADE NEEDED or Connection Refused errors, apply these steps:

1. Force Upgrade (Manual Link)
Manually point Cosmovisor to the new v0.3.0 binary:
...
If your node is running but not syncing new blocks, update your peer list to connect with other v0.3.0 nodes:
```bash
...
Apply changes and check the logs:
```bash
